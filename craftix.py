...
def update_workspace(results = []):
	...
	if modules == "mechanical_crafting":#mechanical_crafting
		...
		module06_text00=tk.Entry(root,width=7,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
	...
	if modules == "furnace":#furmace
		...
		module01_text00=tk.Entry(module01_frame00,width=9,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
		module01_text00.place(x=105,y=33)
		module01_text01=tk.Entry(module01_frame00,width=9,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
		module01_text01.place(x=105,y=61)
		module01_text02=tk.Entry(root,width=7,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
	...
	if modules == "crafting":#crafting table
		...
		module00_text00=tk.Entry(root,width=7,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
	...
	if modules == "crafting_shapeless":#crafting table
		...
		module02_text00=tk.Entry(root,width=7,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
	...
	if modules == "pressing":
		...
		def update_pressing_result(results,update_images = False):
			...
			for result in results:
				...
				text00=tk.Entry(element_frame,width=3,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
				...
				text01=tk.Entry(element_frame,width=3,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
	...
	if modules == "stonecutting":
		...
		module04_text00=tk.Entry(root,width=7,validate="key",background=light_bg_color,borderwidth=0,highlightthickness=1,highlightbackground=outline_collor,highlightcolor=outline_collor,foreground=text_color)
