...
class GUItk(object):
    ...
    def create_msg_widget(self, msg):
        ...
        self.messageArea = tk.Text(
            ...
            self.calc_character_width(),
            wrap=tk.WORD, foreground="#ffffff",highlightbackground="#00ffff",highlightcolor="#00ffff"
        )
        self.set_msg(msg)
    ...
    def create_images_frame(self):
        self.imagesFrame = tk.Frame(self.boxRoot,background="#222222")
        row = 1
        ...
        for _r, images_row in enumerate(filenames):
            ...
            for column_number, filename in enumerate(images_row):
                ...
                this_image['widget'] = tk.Button(
                    self.imagesFrame,
                    takefocus=1,
                    compound=tk.TOP,background="#111111",foreground="#ffffff",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#bbbbbb")
    ...
    def create_buttons(self, choices, default_choice):
        ...
        for row, (button_text, unique_button_text) in enumerate(zip(choices, unique_choices)):
            ...
            this_button['widget'] = tk.Button(
                    ...
                    underline=hotkey_position,foreground="#ffffff",background="#111111",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#bbbbbb")
