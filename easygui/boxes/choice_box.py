...
class GUItk(object):
    ...
    def __init__(self, msg, title, choices, preselect, multiple_select, callback):
        ...
        self.boxRoot = tk.Tk()
        self.boxRoot.config(background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",highlightthickness=1)
    ...
    def create_msg_widget(self, msg):
        ...
        self.msgFrame = tk.Frame(
            self.boxRoot,
            padx=2 * self.calc_character_width(),background="#222222"
        ...
        self.messageArea = tk.Text(
            ...
            pady=(global_state.default_hpad_in_chars *
                  self.calc_character_width()),
            wrap=tk.WORD,foreground="#ffffff",highlightthickness=0
    ...
    def create_choicearea(self):
        ...
        self.choiceboxFrame = tk.Frame(master=self.boxRoot,background="#222222")
        ...
        self.choiceboxWidget = tk.Listbox(self.choiceboxFrame,
                                          ...
                                          bg="#222222",foreground="#ffffff",highlightbackground="#00ffff",highlightcolor="#00ffff",selectbackground="#111111",selectforeground="#ffffff"
                                          )
        ...
        rightScrollbar = tk.Scrollbar(self.choiceboxFrame, orient=tk.VERTICAL,
                                      command=self.choiceboxWidget.yview,background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#222222")
        ...
        bottomScrollbar = tk.Scrollbar(self.choiceboxFrame,
                                       ...
                                       command=self.choiceboxWidget.xview,background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#222222")
    ...
    def create_special_buttons(self):
        ...
        selectAllButton.pack(expand=tk.NO, side=tk.LEFT, padx='2m',
                             pady='1m',
                             ipady="1m", ipadx="2m",background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#111111",activeforeground="#ffffff",foreground="#ffffff")

        clearAllButton = tk.Button(self.buttonsFrame, text="Clear All",
                                   height=1, width=6,background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#111111",activeforeground="#ffffff",foreground="#ffffff")
...
if __name__ == '__main__':
    users_choice = choicebox(choices=['choice1', 'choice2'])
