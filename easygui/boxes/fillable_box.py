...
def __fillablebox(msg, title="", default="", mask=None, image=None, root=None):
    ...
    if root:
        ...
        boxRoot.config(background="#222222")
        boxRoot.withdraw()
    else:
        boxRoot = tk.Tk()
        boxRoot.config(background="#222222")
    ...
    messageFrame = tk.Frame(master=boxRoot,background="#222222")
    ...
    try:
        ...
        tk_Image = None
    if tk_Image:
        imageFrame = tk.Frame(master=boxRoot,background="#222222")
    ...
    buttonsFrame = tk.Frame(master=boxRoot,background="#222222")
    buttonsFrame.pack(side=tk.TOP, fill=tk.BOTH)

    # ------------- define the entryFrame ---------------------------------
    entryFrame = tk.Frame(master=boxRoot,background="#222222")
    ...
    # -------------------- the msg widget ----------------------------
    messageWidget = tk.Message(messageFrame, width="4.5i", text=msg,background="#222222",foreground="#ffffff")
    ...
    # --------- entryWidget ----------------------------------------------
    entryWidget = tk.Entry(entryFrame, width=40,background="#222222",foreground="#ffffff")
    ...
    # ------------------ ok button -------------------------------
    okButton = tk.Button(buttonsFrame, takefocus=1, text="OK",background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#111111",activeforeground="#ffffff",foreground="#ffffff")
    bindArrows(okButton)
    okButton.pack(
    ...
    # ------------------ cancel button -------------------------------
    cancelButton = tk.Button(buttonsFrame, takefocus=1, text="Cancel",background="#222222",highlightbackground="#00ffff",highlightcolor="#00ffff",activebackground="#111111",activeforeground="#ffffff",foreground="#ffffff")
